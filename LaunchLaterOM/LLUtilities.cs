...
namespace LaunchLaterOM
{
    public static class LLUtilities
    {
        ...
        /// <summary>
        /// Allows the use of a Pipe(|) seperator to be used to get files from a directory matching one or more patterns
        /// </summary>
        public static string[] GetFiles(string path, string searchPattern)
        {
            ...
            foreach (string pattern in searchPatterns)
                filesFound.AddRange(System.IO.Directory.GetFiles(path, pattern));
            filesFound.Sort();
        ...
        public static string ResolveShortcutArguments(string filename)
        {
            ShellLink link = new ShellLink();
            ((IPersistFile)link).Load(filename, STGM_READ);
            // TODO: if I can get hold of the hwnd call resolve first. This handles moved and renamed files.  
